...
- Use `AI-generated` when the project is clearly described as primarily generated by AI
- Use `AI-assisted` when the project is clearly human-led with AI assistance
- Use `Built with AI assistance` when AI involvement is apparent but the exact balance is unclear
